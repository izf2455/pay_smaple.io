...
header('Content-type:text/html;charset=utf-8');
	echo "天方夜谭支付提醒您：您还未安装，请<a href=\"/install/\">点此安装</a>";
	exit(0);
}
...
if (!file_exists(ROOT . "install/opao.lock") && file_exists(ROOT . "install/")) {sysmsg("<h2>检测到无“opao.lock”文件</h2><ul><font size=\"4\">如果本站尚未安装天方夜谭支付系统，请<a href=\"/install/\">前往安装</a></font><br>
<font size=\"4\">如果本站已安装天方夜谭支付系统，请手动建立一个空的“opao.lock”文件放置于“/install”目录下，<b>为了您站点安全，在您未完成以上准备工作之前天方夜谭支付系统将不会运作。</b></font></li></ul><br/><h4>为什么必须建立“opao.lock”文件？</h4>因为该文件为天方夜谭支付系统保护文件，无该文件系统就会视为未安装状态，此时任何人都可以安装/重装本站天方夜谭支付系统。<br/><br/>", true);}
