...
<div class="container"><br>
    <div class="row">
        <div class="col-xs-12 col-sm-10 col-md-8 col-lg-6 center-block text-center" style="float: none;">
            <div class="alert alert-success" role="alert"><center>易用、好用、耐用、实用，天方夜谭支付系统更懂你...</center></div>
        </div>
...
<div class="panel panel-black">
	...
	<div class="panel-heading" style="background: #15A638;">
		<h3 class="panel-title" align="center">天方夜谭支付系统-安装</h3>
	</div>
	<div class="panel-body">
	    <p><iframe src="/install/install.txt" style="width:100%;height:300px;"></iframe></p>
        <?php if ($installed) { ?>
		<div class="alert alert-warning">您已经安装过天方夜谭支付系统，如需重新安装请删除<font color=red> “install/opao.lock” </font>文件后再安装！</div>
		<?php }else{?>
...
echo <<<HTML
  ...
  <center>如果已事先填写好config.php文件中相关数据库配置，请 <a href="?do=3&jump=1">点击此处</a> 跳过这一步。<br><font color="red">安装后倘若运行出错，请切换PHP版本至正常运行为止！</font><br>天方夜谭支付系统官方交流群：733140639。</center>
HTML;
?>
	</div>
</div>
...
if(defined("SAE_ACCESSKEY") || $_GET['jump']==1){
 ...
 else echo '<div class="list-group-item list-group-item-info">系统检测到你已安装过天方夜谭支付系统</div>
...
?>";
		if(!$con=DB::connect($db_host,$db_user,$db_pwd,$db_name,$db_port)){
			...
			if(DB::query("select * from opao_config where 1")==FALSE)
				...
				echo '<div class="list-group-item list-group-item-info">系统检测到你已安装过天方夜谭支付系统</div>
				<div class="list-group-item">
					<a href="?do=6" class="btn btn-block btn-info">跳过安装</a>
				</div>
				<div class="list-group-item">
...
<div class="progress progress-striped">
  <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 100%">
	...
	<div class="panel-body">
<?php
	@file_put_contents("opao.lock",'欢迎使用天方夜谭支付系统，这是安装锁文件！没有安全何来支付？');
	echo '<div class="alert alert-info"><font color="green">恭喜，天方夜谭支付系统已安装完成！（安装后倘若运行出错，请切换PHP版本至正常运行为止！）初始管理账号和密码是:admin/admin</font><br/><br/><a href="../">>>网站首页</a>｜<a href="../admin/">>>后台管理</a><hr/>更多设置选项请登录后台管理进行修改，普通用户可安装体验，但仅可预览部分内容，无法修改站点设置，如需正式使用，请在确认服务器可以运行本程序后，尽快联系昂裕QQ：444586924，购买正版授权，感谢您对天方夜谭网络的支持！<br/><br/><font color="#FF0033">如果你的空间不支持本地文件读写，请自行在install/ 目录下建立 opao.lock 空文件！</font></div>';
?>
</div>
</div>
...
<div class="progress progress-striped">
  <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 100%">
	...
	<div class="panel-body">
<?php
	@file_put_contents("opao.lock",'欢迎使用天方夜谭支付系统，这是安装锁文件！没有安全何来支付？2019，我们依旧在努力！');
	echo '<div class="alert alert-info"><font color="green">恭喜，天方夜谭支付系统已安装完成！（安装后倘若运行出错，请切换PHP版本至正常运行为止！）初始管理账号和密码是:admin/admin</font><br/><br/><a href="../">>>网站首页</a>｜<a href="../admin/">>>后台管理</a><hr/>更多设置选项请登录后台管理进行修改，普通用户可安装体验，但仅可预览部分内容，无法修改站点设置，如需正式使用，请在确认服务器可以运行本程序后，尽快联系昂裕QQ：444586924，购买正版授权，感谢您对天方夜谭网络的支持！<br/><br/><font color="#FF0033">如果你的空间不支持本地文件读写，请自行在install/ 目录下建立 opao.lock 空文件！</font></div>';
?>
	</div>
</div>
