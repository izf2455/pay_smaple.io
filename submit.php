...
if ($type == 'alipay') {
    ...
    }elseif ($conf['alipay_api'] == 10) {
        echo "<script>window.location.href='./julingalipay.php?trade_no={$trade_no}&type={$type}&name={$name}&money={$money}&sitename={$sitename}';</script>";
 ...
 if ($conf['wxpay_api'] == 0) {
        ...
        echo "<script>window.location.href='./submit/epay/epay.php?trade_no={$trade_no}&type={$type}&name={$name}&money={$money}&sitename={$sitename}';</script>";
    }elseif ($conf['wxpay_api'] == 10) {
        echo "<script>window.location.href='./julingwxpay.php?trade_no={$trade_no}&type={$type}&name={$name}&money={$money}&sitename={$sitename}';</script>";
