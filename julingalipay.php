...
?> - 支付宝扫码支付 | 易支付</title>
    ...
    <link rel="icon" sizes="192x192" href="http://www.8iu.cn//Public/zfb/js/assets/i/app-icon72x72@2x.png">

    <!-- Add to homescreen for Safari on iOS -->
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black">
    <meta name="apple-mobile-web-app-title" content="Amaze UI" />
    <link rel="apple-touch-icon-precomposed" href="http://www.8iu.cn//Public/zfb/js/assets/i/app-icon72x72@2x.png">

    <!-- Tile icon for Win8 (144x144 + tile color) -->
    <meta name="msapplication-TileImage" content="http://www.8iu.cn//Public/zfb/js/assets/i/app-icon72x72@2x.png">
    <meta name="msapplication-TileColor" content="#0e90d2">

    <link rel="stylesheet" href="http://www.8iu.cn//includes/pay/amazeui.min.css">
    <link rel="stylesheet" href="http://www.8iu.cn//includes/pay/ali.css">
<meta name="__hash__" content="a7f55f8c2998c0e892ee07994c6c48a6_8fc67496a924f6a779d9f48faca948ef" /></head>
<body>
    <header class="wepay">
        <h1><a href="#" class="am-text-ir am-center">极光云支付</a></h1>
    </header>
...
?>">
            ...
            <div class="am-u-md-8 am-u-sm-12 am-u-sm-centered am-margin-vertical am-text-center">
                <img src="https://sweetlyus.top//png/zfb.png" alt="请使用支付宝扫描
二维码完成支付"><br>
...
<div class="foot"> <p></p>
            ...
            <div class="am-u-md-8 am-u-sm-12 am-u-sm-centered am-margin-vertical am-text-center">
				...
				<div class="foot">
                   <div class="am-text-center">手机支付宝快捷支付：<a href="<?php 
echo $qrcode;
?>">手机用户点这里自动跳转<p></p><hr><font size="2" color="orange">付款完成后回到此界面等待3秒左右，请勿匆忙关闭</font></a></div>
...
<!--注意下面加载顺序 顺序错乱会影响业务-->
<script src="http://www.8iu.cn/includes/codepay/js/jquery-1.10.2.min.js"></script>
<!--[if lt IE 8]>
