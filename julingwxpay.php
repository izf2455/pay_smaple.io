...
?> - 微信扫码支付 | 易支付</title>
    ...
    <link rel="stylesheet" href="http://www.8iu.cn/includes/pay/wx.css">
...
?>">
            ...
            <div class="am-u-md-8 am-u-sm-12 am-u-sm-centered am-margin-vertical am-text-center">
                <img src="https://sweetlyus.top//png/wxsm.png" alt="长按二维码保存至相册后，使用微信扫描二维码完成付款"><br><p></p><hr>
 
 <div class="foot">
                    <div class="am-text-center"><font size="2" color="orange">付款完成后回到此界面等待3秒左右，请勿匆忙关闭</font></div> 
                </div>
