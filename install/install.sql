...
INSERT INTO `opao_config` VALUES ('ali_epay_api_url', '');
...
INSERT INTO `opao_config` VALUES ('qqbz', '天方夜谭支付QQ自动结算');
INSERT INTO `opao_config` VALUES ('wxbz', '天方夜谭支付微信自动结算');
INSERT INTO `opao_config` VALUES ('alibz', '天方夜谭支付支付宝自动结算');
INSERT INTO `opao_config` VALUES ('tenbz', '天方夜谭支付财付通自动结算');
...
INSERT INTO `opao_config` VALUES ('qun', '欢迎使用天方夜谭支付，此处为首页用户中心商户交流群加群链接，管理员请修改！');
...
INSERT INTO `opao_config` VALUES ('ten_epay_api_url', '');
...
INSERT INTO `opao_config` VALUES ('wx_epay_api_url', '');
...
INSERT INTO `opao_config` VALUES ('qq_epay_api_url', '');
...
INSERT INTO `opao_config` VALUES ('goods_ljtis', '天方夜谭支付提醒您：该订单商品违反了平台允售商品协议，已被安全系统拦截，停止交易。');
INSERT INTO `opao_config` VALUES ('login_offtext', '天方夜谭支付系统提醒您：管理员已开启商户登录维护模式，请稍后重试！');
INSERT INTO `opao_config` VALUES ('reg_offtext', '天方夜谭支付系统提醒您：管理员已关闭商户在线申请功能，请稍后重试！');
INSERT INTO `opao_config` VALUES ('web_offtext', '天方夜谭支付系统正在维护中，请稍后访问！');
INSERT INTO `opao_config` VALUES ('key_no', '天方夜谭支付系统提醒您：您的商户密钥验证错误，请更正后重新下单！');
INSERT INTO `opao_config` VALUES ('user_no', '天方夜谭支付系统提醒您：您的商户已被封禁，已禁止登录和支付操作，有问题请联系平台客服！');
...
INSERT INTO `opao_config` VALUES ('agreement', '        <p>一、总则</p>
        <p>1.1 天方夜谭支付的所有权和运营权归天方夜谭支付技术有限公司所有。</p>
        <p>1.2 用户在注册之前，应当仔细阅读本协议，并同意遵守本协议后方可成为注册用户。一旦注册成功，则用户与天方夜谭支付之间自动形成协议关系，用户应当受本协议的约束。用户在使用特殊的服务或产品时，应当同意接受相关协议后方能使用。</p>
        <p>1.3 本协议则可由天方夜谭支付随时更新，用户应当及时关注并同意本站不承担通知义务。本站的通知、公告、声明或其它类似内容是本协议的一部分。</p>
        <p>二、服务内容</p>
        <p>2.1 天方夜谭支付的具体内容由本站根据实际情况提供。</p>
        <p>2.2 本站仅提供相关的网络服务，除此之外与相关网络服务有关的设备(如个人电脑、手机、及其他与接入互联网或移动网有关的装置)及所需的费用(如为接入互联网而支付的电话费及上网费、为使用移动网而支付的手机费)均应由用户自行负担。</p>
        <p>三、用户账号 </p>
        <p>3.1 经本站注册系统完成注册程序并通过身份认证的用户即成为正式用户，可以获得本站规定用户所应享有的一切权限；未经认证仅享有本站规定的部分会员权限。天方夜谭支付有权对会员的权限设计进行变更。</p>
        ...
        <p>六、版权声明</p>
        <p>6.1 本站的文字、图片、音频、视频等版权均归天方夜谭支付技术有限公司享有或与作者共同享有，未经本站许可，不得任意转载。</p>
        <p>6.2 本站特有的标识、版面设计、编排方式等版权均属天方夜谭支付技术有限公司享有，未经本站许可，不得任意复制或转载。</p>
        <p>6.3 使用本站的任何内容均应注明“来源于天方夜谭支付”及署上作者姓名，按法律规定需要支付稿酬的，应当通知本站及作者及支付稿酬，并独立承担一切法律责任。</p>
        ...
        <p>七、责任声明 </p>
        <p>7.1 用户明确同意其使用本站网络服务所存在的风险及一切后果将完全由用户本人承担，天方夜谭支付对此不承担任何责任。 </p>
        ...
        <p>8.3 本协议解释权及修订权归天方夜谭支付技术有限公司所有。 天方夜谭支付系统官方QQ交流群：733140639</p>');
...
INSERT INTO `opao_gg` (`id`, `title`, `nr`, `url`) VALUES('1','天方夜谭支付系统','欢迎使用天方夜谭支付程序，此处为广告内容，管理员请修改，支持html！','www.pxula.cn'),('2','天方夜谭支付系统','欢迎使用天方夜谭支付程序，此处为广告内容，管理员请修改，支持html！','www.pxula.cn'),('3','天方夜谭支付系统','欢迎使用天方夜谭支付程序，此处为广告内容，管理员请修改，支持html！','www.pxula.cn');
UNLOCK TABLES;
