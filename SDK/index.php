...
?>
<!-- 本程序制作者 天方夜谭支付系统：www.pxula.cn 盗版狗必死 -->
<!DOCTYPE html>
<html lang="zh-CN">
<head>
  <meta charset="utf-8">
              ...
              <form method="post" action="epayapi.php" role="form"> 
                <div class="form-group mb-2">
                  <div class="input-group input-group-merge input-group-alternative">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="ni ni-lock-circle-open"></i>订&nbsp;单&nbsp;号</span>
                    </div>
                ...
                <div class="form-group mb-2">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" placeholder="商品名称" value="天方夜谭网络测试订单" name="WIDsubject" type="text" readonly="readonly">
                  </div>
                </div>
                <div class="form-group mb-2">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" placeholder="付款金额" value="0.01" name="WIDtotal_fee" type="text" readonly="readonly">
                  </div>
                </div>
